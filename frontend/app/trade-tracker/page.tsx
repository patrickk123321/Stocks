...
const COLUMNS: Record<Category, Column[]> = {
  insiders: [
    ...
    { key: "shares", label: "Shares", group: "Transaction", sortable: true },
    { key: "price_per_share", label: "Price", group: "Transaction", sortable: true },
  ...
  institutions: [
    ...
    { key: "value", label: "Value ($)", group: "Position", sortable: true },
    { key: "shares", label: "Shares", group: "Position", sortable: true },
